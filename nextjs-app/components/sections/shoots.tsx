                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    >
                        {isEN ? (
                            <>
                                <p className="mb-6">
                                    If you participate in <strong className="text-white">filming or photoshooting organized by BioTechUSA</strong>, you will receive the compensation specified in your contract, which we can pay against an invoice. It is important that the invoice is issued in the correct format, as we can only accept and process payments this way. <strong className="text-white">If you are not able to issue an invoice, this section does not apply to you.</strong>
                                </p>
